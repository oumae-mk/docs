...
{: .warning}
> Хотя в описании указано, подключение через USB-C/USB-C кабель не поддерживаются, большинство клавиатур уже отправляется с поддержкой USB-C/USB-C на мастер (левой) половинке.
