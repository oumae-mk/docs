...
Свитчи разных типов отличаются друг от друга формой, строением и положением ног. Из более популярных можно выделить МХ (популярные высокопрофильные свитчи) и choc v1 (популярные низкопрофильные свитчи).

Различия между ними ведут к проблемам с совместимостью свитчей с клавиатурами. Например, на плату рассчитанную только на МХ нельзя установить choc свитчи.
